...
app.main_saft:app adds SAF-T staging routes and the isolated AI storage layer.
Sentry is initialized centrally by app.main when SENTRY_DSN is configured.
"""
